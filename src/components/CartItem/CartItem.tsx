  ...
  return (
    <li className={style.item}>
      <div className={style.wrapper}>
        <NavLink className={style.imageWrapper} to={`/products/${props.product.id}`}>
          <img className={style.image} src={props.product.imageURL} alt="product image" />
        </NavLink>
        <div className={style.infoWrapper}>
          <Measurement {...props.product.measurement} />
          <NavLink className={style.name} to={`/products/${props.product.id}`}>
            {props.product.name}
          </NavLink>
        ...
        <div className={style.controls}>
          ...
          <div className={style.price}>
            <b>{(props.cartItem.total).toFixed(2)} ₸</b>
          </div>
          <span className={dividerStyle.divider}></span>
