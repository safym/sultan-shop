        ...
        <div className={style.body}>
          ...
          <div className={style.info}>
            ...
            <div className={style.actions}>
              ...
              <a className={style.link}>При покупке от 10 000 ₸ бесплатная доставка по Кокчетаву и области</a>
              <a className={style.link}>
                <b>Прайс-лист</b>
            ...
            <div className={expandedBlockStyle.expandedBlock}>
              <div className={expandedBlockStyle.title} onClick={toggleDescriptionOpen}>
                <h3 className={style.subtitle}>Описание</h3>
                <span className={descrptionOpen ? expandedBlockStyle.arrowUp : expandedBlockStyle.arrowDown} />
              </div>
            ...
            <div className={expandedBlockStyle.expandedBlock}>
              <div className={expandedBlockStyle.title} onClick={toggleSpecOpen}>
                <h3 className={style.subtitle}>Характеристики</h3>
                <span className={specOpen ? expandedBlockStyle.arrowUp : expandedBlockStyle.arrowDown} />
              </div>
              <div className={`${expandedBlockStyle.list} ${specOpen ? expandedBlockStyle.open : ""}`}>

                <ul className={`${style.list} ${expandedBlockStyle.item}}`}>
                  <li>
