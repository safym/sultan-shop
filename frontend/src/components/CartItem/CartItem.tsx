    ...
    <li className={style.item}>
      <div className={style.wrapper}>
        ...
        <div className={style.infoWrapper}>
          ...
          <NavLink className={style.name} 
          to={`/products/${props.product.id}`}
          data-testid="item-name">
            {props.product.name}
          </NavLink>
          <p className={style.description} data-testid="item-description">{props.product.description}</p>
        </div>
        <div className={style.controls}>
          ...
          <div className={style.total}>
            <b className={style.price} data-testid="item-price">
              {props.cartItem.total.toFixed(2)} ₸
            </b>
          </div>
          <span className={`${dividerStyle.divider} ${style.divider}`}></span>
          <button
            className={buttonStyle.roundedButton}
